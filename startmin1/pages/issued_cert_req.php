        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">ISSUED CERTIFICATES</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <?php
                                    include 'issued_cert_req_sql.php';
                                ?>
                                <!-- /.panel-heading -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        <a href="http://localhost/issued_certificates/<?php echo $reg_no;?>.json" download><i class="fa fa-fw" aria-hidden="true" title="Copy to use check">&#xf19d</i></a>
